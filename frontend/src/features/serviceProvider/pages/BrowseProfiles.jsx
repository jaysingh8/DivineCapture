    ...
    return (
      <div className="min-h-screen bg-[#f5f7fa] flex items-center justify-center">
        <div className="text-center bg-white rounded-2xl shadow-sm border border-gray-100 p-10 max-w-md">
          ...
          <p className="text-gray-500 text-sm">The profile you're looking for doesn't exist or has been removed.</p>
          <button
            onClick={() => navigate(-1)}
            className="mt-4 px-5 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-medium hover:from-blue-600 hover:to-indigo-600 transition-all duration-200"
          >
            Go Back
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#f5f7fa]">
      ...
      <div className="relative h-48 md:h-56 lg:h-64 bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-500 overflow-hidden">
        ...
        <button
          onClick={() => navigate(-1)}
          className="absolute top-4 left-4 w-9 h-9 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/40 transition-colors"
        >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="border-t border-gray-100 px-5 sm:px-8 py-5">
            <button
              onClick={() => navigate(`/message/${profile._id || id}`)}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98] flex items-center justify-center gap-2"
            >
