      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-500 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 relative z-10">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">All Profiles</h1>
            <p className="text-blue-100 text-sm sm:text-base max-w-xl mx-auto">
              Browse through all our talented photographers, videographers, and editors
            </p>
            <div className="mt-4 inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-full px-4 py-2 text-blue-50 text-sm">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <span>{allProfiles.length} profile{allProfiles.length > 1 ? "s" : ""} available</span>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="relative px-4 pb-4">
                <div className="flex justify-center -mt-10 mb-3">
                  <div className="relative">
                    <img
                      src={profile.profileImage || "https://ui-avatars.com/api/?name=" + encodeURIComponent(profile.name || "P") + "&background=6366f1&color=fff&size=160"}
                      alt={profile.name}
                ...
                {/* ─── Action Button ─── */}
                <button
                  onClick={(e) => { e.stopPropagation(); navigate(`/browse/${profile._id}`); }}
...
export default AllPhotograherDetails;